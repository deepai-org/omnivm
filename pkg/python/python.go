...
"    raise RuntimeError('%sowner dispatch target %s unsupported: %s' % (prefix, target_name, diagnostic), boundary_path='thread_affinity', details={'target': target_name, 'requested_target': requested_target, 'owner_dispatch_target': info})\n"
