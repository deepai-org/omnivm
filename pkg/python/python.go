...
"    return {'runtime': runtime_name, 'origin_runtime': origin_runtime, 'type': err_type, 'message': detail, 'traceback': traceback, 'stack_frames': stack_frames, 'cause_chain': cause_chain, 'boundary_path': parsed_boundary, 'original_error_handle': text_field(field('original_error_handle', 'originalErrorHandle'), None), 'details': details_field(envelope), 'details_json': details_json_field(envelope)}\n"
