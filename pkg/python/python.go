...
"        return None\n"
"    try:\n"
"        return __omnivm_json.dumps(_copy_json_value(value), separators=(',', ':'))\n"
"    except Exception:\n"
"        return str(value)\n"
...
"    return lower.startswith('caused by:') or lower.startswith('details:') or lower.startswith('details_json:') or lower.startswith('detailsjson:') or lower.startswith('original_error_handle:') or lower.startswith('original error handle:') or lower.startswith('original-error-handle:')\n"
...
"    return {'runtime': runtime_name, 'origin_runtime': origin_runtime, 'type': err_type, 'message': detail, 'traceback': traceback, 'stack_frames': stack_frames, 'cause_chain': cause_chain, 'boundary_path': text_field(field('boundary_path', 'boundaryPath'), boundary_path), 'original_error_handle': text_field(field('original_error_handle', 'originalErrorHandle'), None), 'details': details_field(envelope), 'details_json': details_json_field(envelope)}\n"
...
"    try:\n"
"        signature = __omnivm_inspect.signature(method)\n"
"    except Exception:\n"
"        return True\n"
"    for parameter in signature.parameters.values():\n"
"        if parameter.kind in (parameter.VAR_POSITIONAL, parameter.VAR_KEYWORD):\n"
"            continue\n"
"        if parameter.default is __omnivm_inspect.Signature.empty:\n"
"            return False\n"
"    return True\n"
...
"except NameError:\n"
"    __all__ = []\n"
"for __omnivm_name in ('proxy_close', 'aproxy_close', 'omnivm_close', 'omnivm_aclose', 'cleanup_errors'):\n"
...
"    raise RuntimeError('%sowner dispatch target %s unsupported: %s' % (prefix, target_name, diagnostic), boundary_path='owner_dispatch_target', details={'target': target_name, 'requested_target': requested_target, 'owner_dispatch_target': info})\n"
