...
"    return {'runtime': runtime_name, 'origin_runtime': origin_runtime, 'type': err_type, 'message': detail, 'traceback': traceback, 'stack_frames': stack_frames, 'cause_chain': cause_chain, 'boundary_path': field('boundary_path', 'boundaryPath') or boundary_path, 'original_error_handle': field('original_error_handle', 'originalErrorHandle'), 'details': _copy_json_value(envelope.get('details'))}\n"
