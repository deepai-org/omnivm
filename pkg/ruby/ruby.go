...
static int omnivm_ruby_init(void) {
    ...
    if (omnivm_ruby_eval_bootstrap("runtime error prelude",
        ...
        "    end\n"
        "    def to_h\n"
        "      {runtime: @runtime, origin_runtime: @origin_runtime, type: @type, message: message, traceback: @traceback, stack_frames: @stack_frames, cause_chain: @cause_chain, boundary_path: @boundary_path, original_error_handle: @original_error_handle, details: @details}\n"
        "    end\n"
        "    alias to_dict to_h\n"
        ...
        "    {runtime: source_runtime, type: err_type, message: detail, traceback: traceback, stack_frames: OmniVM.__runtime_error_stack_frames(traceback), cause_chain: causes, boundary_path: (boundary_parts.empty? ? fallback_boundary : boundary_parts.join(' > ')), original_error_handle: original_error_handle, details: OmniVM.__parse_runtime_error_details(body)}\n"
        "  end\n"
