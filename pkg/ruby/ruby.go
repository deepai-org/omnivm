...
static int omnivm_ruby_init(void) {
    ...
    if (omnivm_ruby_eval_bootstrap("runtime error prelude",
        ...
        "      out << item\n"
        "    end\n"
        "    {runtime: runtime_name, origin_runtime: origin_runtime, type: err_type, message: detail, traceback: traceback, stack_frames: stack_frames, cause_chain: cause_chain, boundary_path: (field.call(\"boundary_path\", \"boundaryPath\") || boundary_path), original_error_handle: field.call(\"original_error_handle\", \"originalErrorHandle\"), details: __copy_json_value(envelope[\"details\"])}\n"
        "  end\n"
