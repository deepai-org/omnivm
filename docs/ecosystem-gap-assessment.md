...
foreign-runtime cancellation, PyMongo cursor batches with `killCursors`, Redis `scan_iter`, boto3/botocore S3
...
2. Add additional SDK pager/cursor tests for lazy result windows, owner close,
   and backpressure. Prisma cursor-style page windows and psycopg server-side
