...
plain JavaScript `Error` objects can also expose `originalErrorHandle` as a
native property. There is not yet a general guest-native error handle protocol
for non-JS guest errors.
