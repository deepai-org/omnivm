...
Python exceptions can expose `original_error_handle`, and ordinary Ruby
exceptions can expose `@original_error_handle`, as native properties. There is
not yet a general guest-native error handle protocol for Java guest errors.
