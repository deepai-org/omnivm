...
plain JavaScript `Error` objects can expose `originalErrorHandle`, and ordinary
Python exceptions can expose `original_error_handle`, as native properties.
There is not yet a general guest-native error handle protocol for Ruby/Java
guest errors.
