...
aborts with foreign-owned bodies are covered. Deeper custom undici Dispatcher
...
so async-iterator cancellation releases the owner. Additional Puma/native-threaded Ruby server aborts, worker reloads,
