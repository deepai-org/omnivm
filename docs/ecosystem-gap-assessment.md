...
inspection and clean server shutdown. A Fastify hijacked-reply fixture now also
...
multi-chunk Arrow streams, and dictionary-encoded Arrow streams also stay live
proxies unless OmniVM can prove a faithful one-buffer primitive view.
